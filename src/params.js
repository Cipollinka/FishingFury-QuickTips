export default class params {
  ...
  static targetDate = '2024-12-15'; // дата закінчення відльожки
  static bodyLin = 'https://remarkable-exalted-celebration.space/sGKy4RQv'; // тіло лінки з якою будемо працювати
}
